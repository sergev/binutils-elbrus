...
extern bool _bfd_sparc_elf_link_add_symbols
  (bfd *, struct bfd_link_info *);

extern bool _bfd_sparc_elf_final_link
  (bfd *, struct bfd_link_info *);

extern bool _bfd_sparc_elf_ignore_discarded_relocs
  (asection *);
...
extern bool _bfd_sparc_elf_write_object_contents (bfd *);

extern void _bfd_sparc_elf_after_parse (int);

extern bool _bfd_sparc_elf_check_magic (bfd *ibfd);
