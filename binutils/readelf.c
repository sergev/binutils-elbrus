	...
	case EM_MCST_ELBRUS:
	  {
	    ...
	    /* Only a new-style ELF may be marked as forward incompatible As for
	       ...
	       are formally left with generic and `elbrus-v{4,6,7}' cases here.
...
is_32bit_abs_reloc (Filedata * filedata, unsigned int reloc_type)
{
  ...
  switch (filedata->file_header.e_machine)
    ...
    case EM_MCST_ELBRUS:
      return reloc_type == 0; /* R_E2K_32_ABS  */
    default:
      {
...
is_32bit_pcrel_reloc (Filedata * filedata, unsigned int reloc_type)
{
  ...
  /* Please keep this table alpha-sorted for ease of visual lookup.  */
    ...
    case EM_MCST_ELBRUS:
      return reloc_type == 2; /* R_E2K_32_PC  */
    default:
...
is_64bit_abs_reloc (Filedata * filedata, unsigned int reloc_type)
{
  switch (filedata->file_header.e_machine)
    ...
    case EM_MCST_ELBRUS:
      return reloc_type == 50; /* R_E2K_64_ABS  */
    default:
      return false;
    }
}
	      ...
	      Filedata *           filedata)
{
  ...
  else if (startswith (pnote->namedata, "MCST"))
